"""parkinson progression prediction file for ensuring the package is executable
as `parkinson-progression-prediction` and `python -m parkinson_progression_prediction`
"""
import importlib
